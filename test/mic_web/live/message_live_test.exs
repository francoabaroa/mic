defmodule MicWeb.MessageLiveTest do
  use MicWeb.ConnCase

  import Phoenix.LiveViewTest
  import Mic.ChatFixtures

  @create_attrs %{metadata: %{}, role: "some role", assistant_id: "7488a646-e31f-11e4-aace-600308960662", thread_id: "7488a646-e31f-11e4-aace-600308960662", content: "some content"}
