...
if System.get_env("CHARTMETRIC_ENV_SET") do
...
if System.get_env("INSTAGRAM_ENV_SET") do
  config :mic, :instagram,
    ...
    api_url: System.get_env("INSTAGRAM_API_URL"),
    auth_url: System.get_env("INSTAGRAM_AUTH_URL"),
    token_url: System.get_env("INSTAGRAM_TOKEN_URL")
end
...
if config_env() == :prod do
  ...
  config :mic, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
